...
<AccordionGroup>
  <Accordion title="Design not uploading?">
    - Check file type (must be PNG or JPG)
    - Reduce file size if it exceeds the maximum limit
  </Accordion>
  <Accordion title="Product not appearing in store?">
...
Once you’ve published your first product, you’re ready to move on to the next phase: [**<u>Start Selling</u>**](https://docs.rabfy.com/getting-started/start-selling)