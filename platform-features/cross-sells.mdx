...
1. **Navigate to the Cross-Sells Menu**\
   Go to your [Rabfy Dashboard](https://dashboard.rabfy.com) → Offers → Cross-Sells\
...
**Watch this video for details (8:55 min):**

<iframe src="https://www.youtube.com/embed/1Uu0LdrN-p8" title="YouTube video player" frameborder="0" className="w-full aspect-video rounded-xl" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen />