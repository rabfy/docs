...
You can also connect [Google Analytics 4 (GA4)](https://docs.rabfy.com/google-analytics) for more advanced tracking. See the Google Analytics guide for details.
